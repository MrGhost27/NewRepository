...
namespace CharacterCreationandDevelopment
{
	public class FirstConversation : IConversation
	{
		...
		public List<string> GetEventConversation()
		{
			...
			conversationParts.Add(player.name + ": Hi " + conversationNPC.name);
			...
			conversationParts.Add(conversationNPC.name + ": Hi " + player.name + "!" + Environment.NewLine  
                ...
                + "If you want though, we could sneak off and go play instead!");

			conversationParts.Add(player.name + ": I'll think on it - you always were a bad influence on me");

			conversationParts.Add(conversationNPC.name + ": Hey - that's what sisters are for!");
