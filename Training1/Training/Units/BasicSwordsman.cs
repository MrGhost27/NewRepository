...
{
	class BasicSwordsman : BaseUnit, IUnit
	{
		public IStats BaseStats { get { return StatFactory.GetStats(StatType.BasicSoldier); } }
		public List<IAbility> Abilities { get { return AbilityFactory.Abilities(UnitType.Swordsman); } }
		public string Type { get { return "Swordsman"; } }
