namespace statesv3
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Begin running";
			...
			this.button5.Text = "Normal shoes";
			...
			this.button6.Text = "Running shoes";
			...
			this.button7.Text = "Sonic\'s running boots";
			...
			this.label1.Text = "You begin barefoot";
			// 
			// label2
			// 
